...
- Draft a book outline that is thorough and logical, ensuring that the book contain at least 10 chapters, each chapter should contain 3-6 articles, each article should contain 4-8 sections.
...
- Strictly meet the above requirements for the number of chapters, articles and sections of the outline.
